...
const server=http.createServer((req,res)=>{
    if(req.url==='/'){
       handleReadFile("./viwes/index.html",200,req,res);
    }else if(req.url==='/about'){
        handleReadFile("./viwes/about.html",200,req,res);
    }else if(req.url==='/contact'){
        handleReadFile("./viwes/contact.html",200,req,res);
    }else{
        handleReadFile("./viwes/err.html",200,req,res);
    }
})
